#include "GameManager6.h"  // <-- Fixed include
...
GameManager6::GameManager6(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager6::run(  // <-- Fixed class name
...
std::string GameManager6::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager6::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager6::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
