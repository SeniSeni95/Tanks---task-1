#include "GameManager9.h"  // <-- Fixed include
...
GameManager9::GameManager9(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager9::run(  // <-- Fixed class name
...
std::string GameManager9::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager9::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager9::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
