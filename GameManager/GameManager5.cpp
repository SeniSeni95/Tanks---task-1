#include "GameManager5.h"  // <-- Fixed include
...
GameManager5::GameManager5(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager5::run(  // <-- Fixed class name
...
std::string GameManager5::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager5::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager5::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
