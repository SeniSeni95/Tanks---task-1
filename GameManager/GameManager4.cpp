#include "GameManager4.h"  // <-- Fixed include
...
GameManager4::GameManager4(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager4::run(  // <-- Fixed class name
...
std::string GameManager4::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager4::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager4::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
