#include "GameManager11.h"  // <-- Fixed include
...
GameManager11::GameManager11(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager11::run(  // <-- Fixed class name
...
std::string GameManager11::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager11::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager11::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
