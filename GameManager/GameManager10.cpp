#include "GameManager10.h"  // <-- Fixed include
...
GameManager10::GameManager10(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager10::run(  // <-- Fixed class name
...
std::string GameManager10::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager10::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager10::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
