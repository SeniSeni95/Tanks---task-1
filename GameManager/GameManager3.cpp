#include "GameManager3.h"  // <-- Fixed include
...
GameManager3::GameManager3(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager3::run(  // <-- Fixed class name
...
std::string GameManager3::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager3::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager3::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
