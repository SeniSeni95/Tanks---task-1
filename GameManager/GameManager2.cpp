#include "GameManager2.h"  // <-- Fixed include
...
GameManager2::GameManager2(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager2::run(  // <-- Fixed class name
...
std::string GameManager2::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager2::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager2::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
