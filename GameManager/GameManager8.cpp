#include "GameManager8.h"  // <-- Fixed include
...
GameManager8::GameManager8(std::unique_ptr<PlayerFactory> playerFactory,  // <-- Fixed class name and parameter type
...
GameResult GameManager8::run(  // <-- Fixed class name
...
std::string GameManager8::commandStringToEnumName(const std::string& cmd) {  // <-- Fixed class name
...
std::string GameManager8::actionToString(ActionRequest action) {  // <-- Add missing method implementation
...
ActionRequest GameManager8::stringToAction(const std::string& actionStr) {  // <-- Add missing method implementation
