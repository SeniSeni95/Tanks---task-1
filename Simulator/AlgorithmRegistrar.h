class AlgorithmRegistrar {
    ...
    public:
        ...
        void setTankAlgorithmFactory(MyTankAlgorithmFactory&& factory) {
            assert(MyTankAlgorithmFactory == nullptr);
            MyTankAlgorithmFactory = std::move(factory);
        }
        ...
        std::unique_ptr<TankAlgorithm> createTankAlgorithm(int player_index, int tank_index) const {
            return MyTankAlgorithmFactory(player_index, tank_index);
        }
        bool hasPlayerFactory() const {
            return playerFactory != nullptr;
        }
        bool hasTankAlgorithmFactory() const {
            return MyTankAlgorithmFactory != nullptr;
        }
    };
...
public:
    ...
    void addTankAlgorithmFactoryToLastEntry(MyTankAlgorithmFactory&& factory) {
